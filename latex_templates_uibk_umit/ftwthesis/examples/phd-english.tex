...
\Subtitle{Template for preparing Doctoral Theses at the Faculty of Engineering Sciences, University of Innsbruck}
\date{\today}
...
% The evaluator of your thesis. Only applicable in case of PhD theses. In most cases, this will be your principal advisor. If this is indeed true, you may omit these fields whence the data of your advisor will be used.
% \Evaluator{Ao.-Prof. Dr. Ing. Rudolf Stark}
% \EvaluatorUniversity{Universität Innsbruck}
% \EvaluatorDepartment{Institut für Grundlagen der Technischen Wissenschaften}
% \EvaluatorResearchUnit{Arbeitsbereich für Festigkeitslehre}
% \setboolean{EvaluatorFemale}{false}

% Second evaluator of your thesis. Only applicable in case of PhD theses. In case of bachelor thesis, master thesis, or exposes this has no effect and can be removed or commented out.
\EvaluatorTwo{o.~Univ.-Prof. Dipl.-Ing. Dr. Günter Hofstetter}
\EvaluatorTwoUniversity{Universität Innsbruck}
\EvaluatorTwoDepartment{Institut für Grundlagen der Technischen Wissenschaften}
\EvaluatorTwoResearchUnit{Arbeitsbereich für Festigkeitslehre}
\setboolean{EvaluatorTwoFemale}{false}
