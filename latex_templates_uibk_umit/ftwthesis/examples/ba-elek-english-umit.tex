\documentclass[
  ...
  study=Elek, % BauUmwelt, Bau, Umwelt, Mech, Elek, or Doktorat
  uni=UMIT, % LFUI or UMIT
...
\Subtitle{Template for preparing Bachelor Theses in Mechatronics at UMIT TIROL}
\date{\today}


% The (principal) advisor of your thesis. This is necessary for all thesis types (BA, MA, or PhD).
\Advisor{Univ.-Prof. Dr. Frank Woittennek}
\AdvisorUniversity{Universität Innsbruck}
\AdvisorDepartment{Institut für Automatisierungs- und Regelungstechnik}
\AdvisorResearchUnit{}
\setboolean{AdvisorFemale}{false}
